    ...
    <div class="d-flex">
        <div class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('kehadiran.siswa') }}"><i class="fa-solid fa-calendar-check"></i> DAFTAR HADIR</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa-solid fa-graduation-cap"></i> NILAI</a>
                </li>
            </ul>
        </div>
        <div class="content">
            ...
            <div class="table-container">
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        @foreach ($kehadiran as $mapel => $minggu_data)
                            <tr>
                                <td class="subject-column">{{ $mapel }}</td>
                                @for ($i = 1; $i <= 16; $i++)
                                    <td>{{ optional($minggu_data->firstWhere('minggu', $i))->status ?? '-' }}</td>
                                @endfor
                            </tr>
                        @endforeach
                    </tbody>
